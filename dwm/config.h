...
static const char col_gray1[]       = "#1a1b26"; /* Deep neon-blue night background */
static const char col_gray2[]  = "#24283b"; /* Inactive border (Subtle dark purple-gray) */
static const char col_gray3[]       = "#a9b1d6"; /* Muted silver-blue text */
static const char col_cyan []   = "#7aa2f7"; /* Crisp Tokyo neon blue */
...
static const Rule rules[] = {
	...
	{ "floating_window", NULL, NULL,      0,            1,           -1 },
};
...
static const char *gemini[] = { "chromium", "--app=https://gemini.google.com/app", NULL };
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_Return, spawn,          {.v = termcmd } },
        ...
        { MODKEY|ShiftMask,             XK_n,      spawn,	   SHCMD("~/zhnrzk-dwm/scripts/dunst-toggle.sh") },
	{ MODKEY,                       XK_s,      spawn,          {.v = screenshotcmd } },
	{ MODKEY|ShiftMask,		XK_s,      spawn,	   {.v = screenrecorderCmd } },
        { MODKEY,                       XK_b,      spawn,          {.v = firefoxcmd } },
	{ MODKEY,                       XK_p,      spawn,          {.v = clipmenucmd } },
	{ MODKEY, 			XK_e,      spawn,          {.v = filemanager } },
	{ MODKEY|ShiftMask,		XK_a,      spawn,	   {.v = gemini } },
	{ MODKEY|ShiftMask,		XK_l,	   spawn,	   SHCMD("~/zhnrzk-dwm/scripts/toggle-lock.sh") },
